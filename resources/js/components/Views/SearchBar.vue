<template>
    <div>
        ...
        <div class="relative z-10">
            ...
            <input type="text" name="" id="searchTerm" @focus="focus = true" placeholder="Search..." v-model="searchTerm" @input="search" class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100">
