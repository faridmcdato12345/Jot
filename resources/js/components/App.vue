    ...
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400 pl-6">
                <nav class="pt-4">
                    <router-link to="#">
                        <svg class="fill-current text-blue-600 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <p class="font-bold text-xs pt-12 uppercase text-gray-500">Create</p>
                    ...
                    <p class="font-bold text-xs pt-12 uppercase text-gray-500">General</p>
                    ...
                    <p class="font-bold text-xs pt-12 uppercase text-gray-500">Settings</p>
