...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white pt-8 text-3xl">Welcome Back</h1>
        <h2 class="text-blue-300">Enter you credentials below</h2>
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="email" type="email" class="pt-8 w-full p-3 bg-blue-800 rounded text-gray-100 outline-none focus:bg-blue-700" name="email" autofocus placeholder="your@email.com">
                    @error('email')
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password" type="password" class="pt-8 w-full p-3 bg-blue-800 rounded text-gray-100 outline-none focus:bg-blue-700" name="password" placeholder="password">
                    @error('password')
            ...
            <div class="relative pt-8">
                <div>
                    <button type="submit" class="w-full rounded uppercase text-blue-800 font-bold bg-gray-400 pt-2 pb-2">Login</button>
                </div>
            </div>
            <div class="flex justify-between pt-8 text-white font-bold text-sm">
                <a class="btn btn-link hover:text-blue-300" href="{{ route('password.request') }}">{{ __('Forgot Your Password?') }}</a>
                <a class="btn btn-link hover:text-blue-300" href="{{ route('register') }}">Register</a>
            </div>
        </form>
    </div>
</div>
