...
<div class="h-full flex justify-center items-center bg-gray-300 mx-auto">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white pt-8 text-3xl">Password Reset</h1>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="relative pt-8">
                ...
                <div>
                    <input id="email" type="email" class="pt-8 w-full p-3 bg-blue-800 rounded text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autofocus>
                    @error('email')
            ...
            <div class="relative pt-8">
                <div>
                    <button type="submit" class="w-full rounded uppercase text-blue-800 font-bold bg-gray-400 pt-2 pb-2">Send Password Reset Link</button>
                </div>
            </div>
