...
class ContactsTest extends TestCase
{
    ...
    /** @test */
    public function a_list_of_contacts_can_be_fetch_by_authenticated_user(){
    ...
    /** @test */
    public function an_unauthenticated_user_shoud_be_redirected_to_login(){
        $response = $this->post('/api/contacts',array_merge($this->data(),['api_token'=>'']));
        $response->assertRedirect('/login');
        $this->assertCount(0,Contact::all());
    }
    /** @test */
    public function an_authotenticated_user_can_add_contact(){
    ...
    /** @test */
    public function only_an_authenticated_user_can_patched_contacts(){
        $contact = factory(Contact::class)->create(['user_id'=>$this->user->id]);
        $anotherUser = factory(User::class)->create();
    ...
    /** @test */
    public function only_an_authenticated_user_can_delete_contacts(){
        $contact = factory(Contact::class)->create(['user_id'=>$this->user->id]);
        $anotherUser = factory(User::class)->create();
